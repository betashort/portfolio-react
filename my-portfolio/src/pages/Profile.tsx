...
import {
  profileSkillFrameworkDetails,
  profileSkillProgrammingDetails,
} from "../assets/data/ProfieSkillDetial";
import {
  PolarAngleAxis,
  PolarGrid,
  PolarRadiusAxis,
...
import { skillChartData } from "../assets/data/profileSkillChartData";
    ...
    <>
      <div className="profile overflow-auto snap-y">
        ...
        <div className="skill snap-start h-[50svh]">
          ...
          <div className="skill-chart flex justify-center items-center">
          ...
          <div className="skill-detail grid sm:grid-cols-1 md:grid-cols-3">
            <div className="skill-programming">
              ...
              <ProfileSkillCard
                profileSkillDetails={profileSkillProgrammingDetails}
              />
            </div>
            <div className="skill-framework">
              <h3 className="text-2xl text-center p-3 md:w-6/12">FrameWork</h3>
              <ProfileSkillCard
                profileSkillDetails={profileSkillFrameworkDetails}
              />
            </div>
          </div>
        </div>
